...
export default function Timetable() {
  ...
  return (
    <div>
      <p className="page-title">Weekly Timetable</p>
        ...
        <div className="card-body p-0">
          <div className="table-responsive">
            <table className="table table-bordered mb-0" style={{ minWidth: 800 }}>
              <thead>
                <tr>
                  <th className="bg-primary text-white text-center" style={{ width: 120 }}>Day</th>
              ...
              <tbody>
                {DAYS.map((day) => {
                  ...
                  return (
                    <tr key={day}>
                      <td className="text-center fw-semibold align-middle bg-light">{day}</td>
                      <td className="p-3">
                        {daySlots.length === 0 ? (
